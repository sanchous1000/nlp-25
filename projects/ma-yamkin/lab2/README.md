...
Также дополнительно была постероена и визуализирована матрица термин-документ.
...
2. Запустить прошлую лабораторную работу и сохранить аннотированные корпуса в директории ../assets/annotated-corpus/train и ../assets/annotated-corpus/test относительно текущей.
...
7. Для построения матрицы термин-документ необходимо запустить скрипт `python source/build_terme_doc_matrix.py`
8. Для визуализации запустить скрипт `python source/draw_matrix.py`
